...
//$result=mysql_query("SELECT * FROM user WHERE name=$name");
    ...
    $row=mysqli_fetch_assoc($result);
    $result_user=mysqli_query($conn,"SELECT * FROM say ORDER BY id desc");
    $result_user_1=mysqli_query($conn,"SELECT * FROM say ORDER BY id desc");
...
<div class="panel-heading font-bold" style="background-color: #9999CC;color: white;">留言列表</div>
<div class="well well-sm" style="margin: 0;" id="ljc">共收到<b><?=$list;?></b>条留言</div>
<div class="table-responsive">
    <div style="height:540px;overflow: auto;">
        <table class="table table-striped b-t b-light text-center table-striped" style="white-space:nowrap;text-align:center;">
          <thead><th class="text-center">序号</th><th class="text-center">主题</th><th class="text-center">内容</th><th class="text-center">留言人</th><th class="text-center">留言时间</th></thead>
    <tbody>
...
for($i=0;$i<$user_num;$i++){
        ...
        </table><?php if($id==0) echo '<center><img src="./images/nodata_img_200px.png" width="150px" height="150px"></center>';?>
		      </div></div>
</div>
</div>
</div>
