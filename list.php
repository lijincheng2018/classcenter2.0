...
//$result=mysql_query("SELECT * FROM user WHERE name=$name");
    ...
    $result_get_teachar=mysqli_query($connect_login,"SELECT * FROM classroom_info WHERE data_base='$data_base'");
    $row_get_teachar=mysqli_fetch_assoc($result_get_teachar);
    $bandaoshi=$row_get_teachar['bandaoshi'];
    $bandaoshi_tel=$row_get_teachar['bandaoshi_tel'];
...
<div class="panel-heading font-bold" style="background-color: #9999CC;color: white;">教师列表</div>
<div class="well well-sm" style="margin: 0;" id="ljc">手机端点击电话号码即可快速拨号</div>
<div class="table-responsive">
        <table class="table table-striped b-t b-light text-center">
          <thead><th class="text-center">序号</th><th class="text-center">职务</th><th class="text-center">姓名</th><th class="text-center">电话</th></thead>
    <tbody>
    	<tr class="onclick warning">
                       <tr>
                            ...
                            <td>辅导员</td>
                            <td>薛旭亮</td>
                            <td><a href="tel:18046002758">18046002758</a></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>辅导员</td>
                            <td>陈清耀</td>
                            <td><a href="tel:17805961496">17805961496</a></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>班导师</td>
                            <td><?=$bandaoshi?></td>
                            <td><a href="tel:<?=$bandaoshi_tel?>"><?=$bandaoshi_tel?></a></td>
                        </tr>
...
<div class="wrapper">
<div class="col-sm-12" id='ljc_bg_1'>	
<div class="panel panel-default">
<div class="panel-heading font-bold" style="background-color: #9999CC;color: white;">学生列表</div>
<div class="well well-sm" style="margin: 0;" id="ljc">共<b><?=$user_num;?></b>位同学</div>
<div class="table-responsive">
        <table class="table table-striped b-t b-light text-center">
...
<script language="JavaScript">
    ...
    watermark({"watermarl_element":'ljc_bg_1',"watermark_txt":'软工2201班级信息中心'+userName+" "+nowTime})
</script>
