  ...
  <div class="panel panel-success">
   ...
   <div class="panel panel-success">
    ...
    <div class="tab-pane fade in active" id="all">
       <div class="well well-sm" style="margin: 0;"><?php echo('总人数：'.$dataCount_1.'&nbsp;&nbsp;已完成人数：'.($tot_1)); ?>&nbsp;&nbsp;<a class="btn btn-xs btn-danger" href="javascript:;" onclick="createfile()">导出为Excel数据</a><br><br><a href="./get.php?id=all&fid=<?=$form_id?>" class="btn btn-success" onclick="down()">一键打包并下载</a><br>
  由于总文件较大，云端压缩可能比较<b>慢</b>，点击按钮后，请<b>稍等片刻</b>，未弹出下载框前，<b>不要重复点击按钮</b>！</div>
          <div class="table-responsive">
