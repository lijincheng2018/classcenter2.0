...
<div class="well well-sm" style="margin: 0;">你共需要完成<b><?=$list?></b>张文件收集表</div>
<div class="table-responsive">
        <table class="table table-responsive b-t b-light text-center">
          <thead><th class="text-center">序号</th><th class="text-center" width="20%">收集表标题</th><th class="text-center" width="20%">是否完成</th><th class="text-center" width="20%">发布人</th><th class="text-center">发布时间</th><th class="text-center">操作</th></thead>
          <tbody>
            ...
            $author=$result_arr['author'];
                ...
                for($j=0;$j<$people_num;$j++)
                {
                    if($peoples[$j]==$uid){
                        ...
                        $control='<a class="btn btn-success btn-xs" href="./collect_file?id='.$fid.'">前往提交</a>';
                        echo '<tr>
                                    <td>'.$a_id.'</td>
